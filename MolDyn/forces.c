...
#pragma omp parallel for default(none) \
 shared(npart, x, f, side, rcoff, sideh, rcoff) \
private(i,j,sideh,rcoffs,xi,yi,zi,fxi,fyi,fzi,xx,yy,zz,rd, rrd, rrd2, rrd3, rrd4, rrd6, rrd7, r148,forcex, forcey, forcez) \
reduction(+:epot,vir)\
 schedule(static, 1)
